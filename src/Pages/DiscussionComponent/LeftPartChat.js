...
function LeftPartChat() {
    return (
        <div className="demo-roomss">
            <div className="demo-room-name">
                <h1 className="demo-rm-nm">ROOM NAME</h1>
                <p className="alg">ALGORITHMS</p>
            </div>
            <div className="demo-created">
                <h1 className="demo-head">CREATED BY</h1>
                <h1 className="demo-created-name">MOHAN</h1>
                <img src={me} className="demo-created-img"></img>
                <p className="demo-created-mail">mohanprasaath269@gmail.com</p>
            </div>
